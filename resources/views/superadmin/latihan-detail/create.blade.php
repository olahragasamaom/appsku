...
@section('title', 'Tambah Latihan Detail')
...
@section('breadcrumb')
    ...
    <span class="text-secondary-400">/</span>
    <span class="text-secondary-900 font-medium">Tambah Transaksi</span>
@endsection

@section('header')
    <div>
        <h1 class="text-2xl font-bold text-secondary-900">Tambah Transaksi Detail</h1>
        <p class="text-secondary-500 mt-1">Isi form transaksi dan tambahkan item produk menggunakan modal picker</p>
    </div>
@endsection
...
<div x-data="{
    ...
    <form action="{{ route('superadmin.latihan-detail.store') }}" method="POST">
        @csrf
                    ...
                    <select name="latihan_kategori_id" 
                        ...
                        @foreach($kategoris as $kategori)
                            <option value="{{ $kategori->id }}" 
                                    {{ old('latihan_kategori_id') == $kategori->id ? 'selected' : '' }}>
                                {{ $kategori->nama }}
                            </option>
                        @endforeach
                    </select>
