...
@section('header')
    <h1 class="text-2xl font-bold text-secondary-900">Edit Plan</h1>
    <p class="text-secondary-500 mt-1">{{ $plan->name }}</p>
@endsection
            ...
            <div class="card-body space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              placeholder="Deskripsi singkat tentang plan ini...">{{ old('description', $plan->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- Price Monthly --}}
                    <div x-data="currencyInput({{ old('price_monthly', $plan->price_monthly ?? 0) }})">
                    ...
                    {{-- Price Yearly --}}
                    <div x-data="currencyInput({{ old('price_yearly', $plan->price_yearly ?? 0) }})">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_employees" id="max_employees" value="{{ old('max_employees', $plan->max_employees) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $plan->sort_order) }}"
