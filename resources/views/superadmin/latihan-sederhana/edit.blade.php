...
@section('title', 'Edit Latihan Sederhana')
...
@section('breadcrumb')
    ...
    <span class="text-secondary-400">/</span>
    <span class="text-secondary-900 font-medium">Edit Data</span>
@endsection

@section('header')
    <div>
        <h1 class="text-2xl font-bold text-secondary-900">Edit Latihan Sederhana</h1>
        <p class="text-secondary-500 mt-1">Ubah data di form di bawah</p>
    </div>
@endsection

@section('content')
    <form action="{{ route('superadmin.latihan-sederhana.update', $latihan_sederhana) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="card-body space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="judul" 
                           id="judul" 
                           value="{{ old('judul', $latihan_sederhana->judul) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="kode" 
                           id="kode" 
                           value="{{ old('kode', $latihan_sederhana->kode) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="penulis" 
                           id="penulis" 
                           value="{{ old('penulis', $latihan_sederhana->penulis) }}"
                ...
                <div>
                    ...
                    <textarea name="keterangan" 
                              ...
                              placeholder="Masukkan keterangan (opsional)">{{ old('keterangan', $latihan_sederhana->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                    @enderror
                </div>
