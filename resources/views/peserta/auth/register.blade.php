...
<head>
    ...
    <title>Daftar Peserta - Panritta</title>
...
<div class="min-h-screen flex">
            ...
            <div class="flex-1 flex items-center justify-center">
                <div class="max-w-md">
                    <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                        ...
                        <span class="text-white/90 text-sm font-medium">Gratis untuk Memulai</span>
                    </div>

                    <h1 class="text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                        Langkah Awal<br>Menuju NIP Impian
                    </h1>
                    <p class="text-primary-100 text-lg mb-10">
                        Buat akun dan mulai berlatih. Pilih paket gratis untuk mencoba, atau premium untuk akses penuh.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-white">100% Mirip CAT BKN Asli</span>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                                <svg class="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            </div>
                            <span class="text-white">Ribuan Bank Soal Ter-update</span>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                                <svg class="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            </div>
                            <span class="text-white">Pilih Paket Gratis atau Premium</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    {{-- Panel Kanan - Form --}}
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-8 bg-white overflow-y-auto">
        <div class="w-full max-w-md py-8">
            ...
            <div class="text-center mb-8">
                <h2 class="text-2xl lg:text-3xl font-bold text-secondary-900 mb-2">Daftar Akun Baru</h2>
                <p class="text-secondary-500">Buat akun untuk memulai tryout & memilih paket belajar</p>
            </div>
            ...
            <form method="POST" action="{{ route('peserta.register') }}" class="space-y-5">
                ...
                <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 bg-white text-secondary-500">atau daftar dengan</span>
                    </div>
                </div>
            ...
            <p class="text-center mt-8 text-secondary-600">
                Sudah punya akun?
                <a href="{{ route('peserta.login') }}" class="text-primary-600 hover:text-primary-700 font-semibold">Masuk di sini</a>
            </p>
        </div>
    </div>
</div>
