...
<head>
    ...
    <title>Daftar Peserta Baru - Panritta</title>
...
<body class="font-sans antialiased bg-slate-50 min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-primary-900 relative overflow-hidden items-center justify-center p-12">
        ...
        <div class="relative z-10 max-w-lg text-white">
            ...
            <h2 class="text-4xl font-extrabold mb-6 leading-tight">Langkah Awal Menuju NIP Impianmu</h2>
            <p class="text-primary-100 text-lg mb-8 leading-relaxed">Bergabunglah dengan ribuan pejuang CPNS & Kedinasan lainnya. Dapatkan akses ke platform simulasi CAT paling realistis dan bank soal ter-update hari ini juga.</p>
            
            <div class="space-y-4">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-primary-800/50 flex items-center justify-center">
                    ...
                    <span class="text-primary-50">100% Mirip CAT BKN Asli</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-primary-800/50 flex items-center justify-center">
                        <svg class="w-4 h-4 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <span class="text-primary-50">Sistem Perankingan Nasional</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-primary-800/50 flex items-center justify-center">
                        <svg class="w-4 h-4 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <span class="text-primary-50">Pilih Paket Gratis atau Premium</span>
                </div>
            </div>
        </div>
    </div>

    {{-- Kanan: Area Form Pendaftaran --}}
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 overflow-y-auto">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8">
                ...
                <p class="text-slate-500 mt-2">Buat akun untuk memulai tryout dan memilih paket belajar Anda.</p>
            </div>
            ...
            <form method="POST" action="{{ route('peserta.register') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    <label for="phone" class="block text-sm font-medium text-slate-700 mb-1.5">Nomor WhatsApp <span class="text-slate-400 font-normal">(Opsional)</span></label>
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-3 bg-slate-50 text-slate-500 font-medium">ATAU DAFTAR DENGAN</span>
                    </div>
                </div>
            ...
            <p class="mt-8 text-center text-sm text-slate-600">
                Sudah punya akun? 
                <a href="{{ route('peserta.login') }}" class="font-bold text-primary-600 hover:text-primary-700">Masuk di sini</a>
            </p>
        </div>
    </div>
</body>
