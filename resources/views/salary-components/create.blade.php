...
@section('breadcrumb')
    ...
    <span class="text-slate-700 font-medium">Tambah Komponen</span>
@endsection

@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Tambah Komponen Gaji</h1>
            <p class="text-secondary-500 mt-1">Buat komponen pendapatan atau potongan baru.</p>
        </div>
    ...
    <div class="max-w-3xl">
        <form action="{{ route('salary-components.store') }}" method="POST"
              x-data="{
                  ...
                  componentType: '{{ old('type', 'earning') }}',
                  isAttendanceBased: {{ old('is_attendance_based', false) ? 'true' : 'false' }},
                  attendanceCalculation: '{{ old('attendance_calculation', 'daily') }}'
              }">
            @csrf
                ...
                <div class="card-body space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="2"
                                  ...
                                  placeholder="Deskripsi singkat tentang komponen ini...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" x-model="componentType"
                                ...
                                <option value="earning">Pendapatan (Tambahan)</option>
            ...
            <div class="card mb-6">
                ...
                <div class="card-body space-y-4">
                    ...
                    {{-- Fixed Amount --}}
                    <div x-show="calculationType === 'fixed'" x-cloak x-data="currencyInput({{ old('default_amount', 0) }})">
                    ...
                    <div x-show="calculationType === 'percentage'" x-cloak class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="percentage_base" id="percentage_base"
                                ...
                                <option value="basic_salary" {{ old('percentage_base', 'basic_salary') === 'basic_salary' ? 'selected' : '' }}>Gaji Pokok</option>
                                <option value="gross_salary" {{ old('percentage_base') === 'gross_salary' ? 'selected' : '' }}>Gaji Kotor</option>
                            </select>
            ...
            <div class="card mb-6" x-show="componentType === 'earning'">
                ...
                <div class="card-body space-y-4">
                    ...
                    <div x-show="isAttendanceBased" x-cloak class="space-y-4 pt-4 border-t border-secondary-200">
                        ...
                        {{-- Daily Rate --}}
                        <div x-show="attendanceCalculation === 'daily'" x-cloak x-data="currencyInput({{ old('daily_rate', 0) }})">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <input type="checkbox" name="include_half_days" id="include_half_days" value="1"
                                       class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500"
                                       {{ old('include_half_days', true) ? 'checked' : '' }}>
